...
public class ErrorHandlingTest {
	...
	/*
	 * Prerequisite: getting into https://www.10bis.co.il/ Given: Client click
	 * connection and When: try to login without type email Then: Getting error
	 * message: must fill field
	 */

	@Test(priority = 1, enabled = true, description = "Verify error msg in Login form")
	public void verifyErrorMsgInLogin()
